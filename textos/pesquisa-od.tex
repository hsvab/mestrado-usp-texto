...
% ---
\chapter{As Pesquisas Origem Destino da RMSP}\label{chap:pesquisa-od}
...
\begin{quadro}[htb]
    \IBGEtab{
        ...
        \begin{tabular}{P{2cm}P{4cm}P{5cm}}
           \toprule
		       \headerCell{Ano} & 
		       \headerCell{Mês de Referência} & 
		       \headerCell{Classificação de Referência para Atribuição da Renda}\\ 
		    \midrule\midrule
		        1977&
		    	setembro&
