...
% \cite{SANTANA2013,MALINI2013}. 
%\emph{participação versus representação}, além 
% \cite[p.78]{CASTELLS1999}.
% \begin{compactitem}
%    \item o conhecimento e reconhecimento de instrumentos digitais de participação por membros de organizações da sociedade civil (OSC)
%    \item o reconhecimento e o impacto de instrumentos digitais de participação social pelo poder público
% \end{compactitem}
...
Segundo \citeauthoronline{FREITAG2007} (\citeyear{FREITAG2007}), São Paulo é também uma ``megalópole'', isto e uma megacidade (município com mais de 10 milhões de habitantes) e que sofreu um crescimento muito acelerado nas três ou quatro últimas décadas do século XX.}
...
Diversos estudos constatam \hl{(REF)} que os automóveis particulares ocupam maior quantidade de espaço de circulação para transportar a mesma quantidade de pessoas do que outros motos de transporte (motorizados ou não).  
