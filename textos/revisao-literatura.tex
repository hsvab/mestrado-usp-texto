...
%\begin{enumerate}[(i)]
%\item reduzir a necessidade de viajar;
%\item encorajar a troca para modos de transporte coletivo ou não motorizado;
%\item reduzir o comprimento das viagens;
%\item incentivar a adoção de sistemas e tecnologias de transporte mais eficientes, tanto para carga quanto para passageiros;
%\item reduzir a utilização de carros e caminhões de carga nas áreas urbanas;
%\item reduzir, na fonte, ruídos e emissões dos veículos,
%\item incentivar a utilização mais eficiente e ambientalmente consciente do estoque de veículos;
%\item melhorar a segurança de pedestres e de todos usuários das (rodo)vias;
%\item melhorar a atratividade das cidades para seus moradores, trabalhadores, compradores e visitantes.
%\end{enumerate}
