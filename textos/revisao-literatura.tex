...
\hl{>>> Desenvolver mais este ponto sobre equidade + espaciliadade das oportunidades}

\hl{>>> Ver Vasconcellos - mais alguma ref?}

Figura \ref{fig:inequidade-espaco}

\begin{figure}[htb]%
    \caption{\label{fig:inequidade-espaco}Quantidade de espaço requerido para transportar o mesmo número de passageiros (60) de ônibus, de bicicleta e de carro}%
    \begin{center}%
        \includegraphics[width=0.75\textwidth]{./imagens/equidade-sqn.png}%
    \end{center}%
    \fonte{Foto de \emph{Cycling Promotion Fund}, disponível em \url{http://www.bhtrans.pbh.gov.br/portal/page/portal/portalpublico/Temas/ObservatorioMobilidade/FiquePorDentro/ObsMobBH\%20A\%20cidade\%20com\%20menos\%20carros} Acesso em 22 de novembro de 2014}
\end{figure}%

\clearpage
Segundo \apudonline{URRY2004}{UTENG2008}, tendo em vista as inequidades de acesso estruturadas socialmente, há cinco ``mobilidades'' bastante interdependentes:
\begin{compactitem}[]
\item (i) viagem corpórea das pessoas por motivo de trabalho, lazer, etc.;
\item (ii) movimento físico de objetos (cargas);
\item (iii) viagem imaginativa a lugares por meio de imagens de lugares (fotos ou televisão);
\item (iv) viagem virtual em tempo real pela internet; 
\item (v) viagem comunicativa através de mensagens trocadas entre pessoas (cartas, mensagens de celular, telefone).
\end{compactitem}

Não é possível considerar então a mobilidade do indivíduo, isolando-o; muito pelo contrário, só é possível entendê-la se considerarmos os ambientes em que se ancora: doméstico, familiar e social \cite{HANSON2010}. Assim, acrescido do significado de urbano definido pelo IBGE, neste trabalho, adotar-se-á fundamentalmente o conceito de mobilidade relacionado ao item (i) de \apudonline{URRY2004}{UTENG2008}, mais detalhado no artigo \emph{Gender and mobility: new approaches for informing sustainability} de \citeauthoronline{HANSON2010}, que emprega o termo para designar:
