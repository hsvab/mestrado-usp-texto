...
Entretanto, esta abordagem não exclui necessariamente a anterior. Para \citeauthoronline{MINAYO1996} (\citeyear{MINAYO1996}) as duas metodologias podem ser integradas num mesmo projeto, sendo que a parte qualitativa pode ser suscitada por uma investigação quantitativa prévia e adequa-se mais para explicar situações particulares, de grupos específicos, ou de universos simbólicos.
