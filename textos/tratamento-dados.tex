...
\begin{quadro}[htb]
    \IBGEtab{
        ...
        \ABNTEXfontereduzida
        \caption[\textit{Layout} do Banco de Dados Unificado]{\label{qua:layout-haydee}\emph{Layout} do Banco de Dados Unificado}
	}{%
...
\begin{table}[htb]
	...
	\end{tabular}
		...
		\fonte{Compilação a partir de \citeauthoronline{OD77} (\citeyear{OD77,OD87,OD97,OD07})}
	}
\end{table}
...
Para cada faixa horária, foi gerada uma \textit{dummy} de período correspondente. Tal divisão, também adotada por \citeauthoronline{GERMANI2005} (\citeyear{GERMANI2005}), foi a que melhor refletiu as concentrações de atividades e pode ser observada no Quadro \ref{qua:dum-per}.

\begin{quadro}[htb]
    \IBGEtab{
        \renewcommand{\arraystretch}{1.5}
        \ABNTEXfontereduzida
        \caption{\textit{Dummies} de período}
        \label{qua:dum-per}
  	}{%
        \begin{tabular}{P{1.0cm}P{6.0cm}P{5.0cm}}       
           \hline
		       ...
		       \headerTabCenterCell{\textit{Dummy} resultante}\\ 		        
		    \hline\hline
		    	0 & não fez viagem & - \\
			\hline
		    	1 & madrugada (entre 0h01 e 5h00) & VIAG_PER_MADRUG\\
			\hline
		    	2 & começo da manhã (entre 5h01 e 9h00) & VIAG_PER_COM_MAN\\
			\hline			
		    	3 & manhã (entre 9h01 e 12h) & VIAG_PER_MANHA\\
			\hline
		    	4 & meio-dia tarde (entre 12h01 e 14h) & VIAG_PER_MEIODIA\\
			\hline
		    	5 & tarde (entre 14h01 e 17h) & VIAG_PER_TARDE\\
			\hline
		    	6 & começo da noite (17h01 e 22h) & VIAG_PER_COM_NOI\\
			\hline			
		    	7 & noite (22h01 e 0h) & VIAG_PER_NOITE\\
			\bottomrule												
		\end{tabular}	    		    	
	}{%
		%\fonte{Elaboração própria a partir das OD-1977, OD-1987, OD-1997 e OD-2007}
...
O Quadro \ref{qua:cont-modo} apresenta estas variáveis criadas.

\begin{quadro}[htb]
    \IBGEtab{
        \renewcommand{\arraystretch}{1.5}
        \ABNTEXfontereduzida
        \caption{Variáveis de contagem da utilização dos modos}
        \label{qua:cont-modo}
  	}{%
        \begin{tabular}{P{5.0cm}P{8.0cm}}             
           \hline
			...
			\hline			
		    	VIAG_MODO_TREM & viagens feitas por metrô ou trem\\
			\hline
			...
			\hline			
		    	VIAG_NO_MODOS & quantos modos diferentes foram utilizados, por viagem, de acordo com estas categorias\\
			\bottomrule												
		\end{tabular}	    		    	
	}{%
		%\fonte{Elaboração própria a partir das OD-1977, OD-1987, OD-1997 e OD-2007}
...
\begin{quadro}[htb]
    \IBGEtab{
        \renewcommand{\arraystretch}{1.5}
        \ABNTEXfontereduzida
        \caption{\textit{Dummies} de motivos de viagem}
        \label{qua:dummy-motivo}
  	}{%
        \begin{tabular}{P{7.0cm}P{6.0cm}}             
           \hline
		       \headerTabCenterCell{\textit{Dummy}}&
		       \headerTabCenterCell{Descrição}\\ 		        
		    \hline\hline
		    	VIAG_MOTIVO_SERV_PAS & indica se o motivo da viagem foi servir passageiro\\
			\hline
		    	VIAG_MOTIVO_TRAB  & indica se o motivo da viagem foi trabalho\\
			\hline
		    	VIAG_MOTIVO_EDUC & indica se o motivo da viagem foi educação\\
			\hline			
		    	VIAG_MOTIVO_RES & indica se o motivo da viagem foi residência\\
			\hline
		    	VIAG_MOTIVO_MANUT_COMPRAS & indica se o motivo da viagem foi manutenção da casa (compras) ou da família (saúde)\\
			\hline
		    	VIAG_MOTIVO_LAZER_OUTROS & indica se o motivo da viagem foi lazer ou outros\\
			\bottomrule												
		\end{tabular}	    		    	
	}{%
		%\fonte{Elaboração própria a partir das OD-1977, OD-1987, OD-1997 e OD-2007}
...
\begin{quadro}[htb]
    \IBGEtab{
        \renewcommand{\arraystretch}{1.5}
        \ABNTEXfontereduzida
        \caption{\textit{Dummies} de faixa etária}
        \label{qua:dum-et}
  	}{%
        \begin{tabular}{P{1.0cm}P{6.0cm}P{5.0cm}}       
           \hline
		       ...
		       \headerTabCenterCell{\textit{Dummy} resultante}\\ 		        
		    \hline\hline
		    	0 & 0 a 4 anos & FX_ET_0\\
			\hline
		    	1 & 5 a 9 anos & FX_ET_1\\
			\hline
		    	2 & 10 a 14 anos & FX_ET_2\\
			\hline			
		    	3 & 15 a 19 anos & FX_ET_3\\
			\hline
		    	4 & 20 a 24 anos & FX_ET_4\\
			\hline
		    	5 & 25 a 29 anos & FX_ET_5\\
			\hline
		    	6 & 30 a 34 anos & FX_ET_6\\
			\hline			
		    	7 & 35 a 39 anos & FX_ET_7\\
			\hline
		    	8 & 40 a 44 anos & FX_ET_8\\
			\hline
		    	9 & 45 a 49 anos & FX_ET_9\\
			\hline			
		    	10 & 50 a 54 anos & FX_ET_10\\
			\hline
		    	11 & 55 a 59 anos & FX_ET_11\\
			\hline
		    	12 & 60 a 64 anos & FX_ET_12\\
			\hline
		    	13 & 65 a 69 anos & FX_ET_13\\
			\hline			
		    	14 & 70 a 74 anos & FX_ET_14\\
			\hline
		    	15 & 75 a 79 anos & FX_ET_15\\
			\hline			
		    	16 & 80 a 84 anos & FX_ET_16\\
			\hline
		    	17 & 85 a 89 anos & FX_ET_17\\
			\hline
		    	18 & 90 a 94 anos & FX_ET_18\\
			\hline
		    	19 & 95 a 99 anos & FX_ET_19\\
			\hline			
		    	20 & mais de 100 anos & FX_ET_20\\
			\bottomrule												
		\end{tabular}	    		    	
	}{%
		%\fonte{Elaboração própria a partir das OD-1977, OD-1987, OD-1997 e OD-2007}
...
\begin{quadro}[htb]
    \IBGEtab{
        \renewcommand{\arraystretch}{1.5}
        \ABNTEXfontereduzida
        \caption{Categorias da variável Faixa de Renda Individual}
        \label{qua:fx-rend-ind}
  	}{%
        \begin{tabular}{P{1.0cm}P{8.0cm}P{3.0cm}}       
           \hline
   		       \headerTabCenterCell{Categoria} & 
		       \headerTabCenterCell{em R\$} &
		       \headerTabCenterCell{em Salário Mínimo}\\ 		        
		    \hline\hline
		    	0 & 0 & sem renda\\
			\hline
		    	1 & até R\$380 (exclusive) & até 1 SM\\
			\hline
		    	2 & de R\$380 (inclusive) até R\$760 (exclusive) & de 1 a 2 SM\\
			\hline			
		    	3 & de R\$760 (inclusive) até R\$1140 (exclusive) & de 2 a 3 SM\\
			\hline			
		    	4 & de R\$1140 (inclusive) até R\$1900 (exclusive) & de 3 a 5 SM\\
			\hline			
		    	5 & de de R\$1900 (inclusive) até R\$3800 (exclusive) & de 5 a 10 SM\\
			\hline			
		    	6 & de R\$3800 (inclusive) até R\$5700 (exclusive) & de 10 a 15 SM \\
			\hline			
		    	7 & mais de R\$5700 (inclusive) & mais de 15 SM\\
			\bottomrule												
		\end{tabular}	    		    	
	}{%
		%\fonte{Elaboração própria a partir das OD-1977, OD-1987, OD-1997 e OD-2007}
...
\footnote{Lei do salário mínimo de 2007: \url{ https://www.planalto.gov.br/ccivil_03/_Ato2007-2010/2007/Lei/L11498.htm} Acesso em 30 de setembro de 2015.}.
    ...
    \IBGEtab{
        \renewcommand{\arraystretch}{1.5}
        \ABNTEXfontereduzida
        \caption{Categorias da variável Faixa de Renda Familiar}
        \label{qua:fx-rend-fam}
  	}{%
        \begin{tabular}{P{1.0cm}P{8.0cm}P{3.0cm}}       
           \hline
   		       \headerTabCenterCell{Categoria} & 
		       \headerTabCenterCell{em R\$} &
		       \headerTabCenterCell{Classe Econômica}\\ 		        
		    \hline\hline
		    	0 & 0 & sem renda\\
			\hline
		    	1 & até R\$760 (exclusive) & classe E\\
			\hline
		    	2 & de R\$760 (inclusive) até R\$1520 (exclusive) & classe D\\
			\hline			
		    	3 & de R\$1520 (inclusive) até R\$3800 (exclusive) & classe C\\
			\hline			
		    	4 & de R\$3800 (inclusive) até R\$7600 (exclusive) & classe B\\
			\hline			
		    	5 & mais de R\$7600 (inclusive) & classe A\\
			\bottomrule												
		\end{tabular}	    		    	
	}{%
		%\fonte{Elaboração própria a partir das OD-1977, OD-1987, OD-1997 e OD-2007}
...
\begin{quadro}[htb]
    \IBGEtab{
        \renewcommand{\arraystretch}{1.5}
        \ABNTEXfontereduzida
        \caption{\textit{Dummies} de presença de crianças na família}
        \label{qua:dummy-crianca}
  	}{%
        \begin{tabular}{P{4.5cm}P{9.0cm}}             
           \hline
		       ...
		       \headerTabCenterCell{Descrição}\\ 		        
		    \hline\hline
		    	PRESENCA_FILH_ate4  & indica se a família conta com crianças até 4 anos\\
			\hline
...
\citeauthoronline{VASCONCELLOS2001}\ (\citeyear{VASCONCELLOS2001}) aponta que aspectos econômicos e sociais influenciam os padrões de mobilidade das pessoas e destaca, dentre os sociais, a família como um dos fatores importantes na tomada de decisões em relação aos deslocamentos e arranjos das atividades diárias. Desta forma, foi criada a \textit{dummy} PRESENCA_IDOSO_60 para indicar se a família conta com pessoa idosa com mais de 60 anos.
\end{compactitem}
