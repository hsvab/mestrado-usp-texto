...
%Primeiro aplica-se aos domicílios, às famílias e às pessoas pesquisadas , \eqref{eq:fator-expansao-fam} e \eqref{eq:fator-expansao-pess}.
...
%Verificar com Emilia: de onde vem os totais (numeradores da expressões) dos fatores de expansão das família e das pessoas? Pq o totalde domicílios vem do cadastro das concessionárias, mas e os outros totais?
...
%, sendo a menor unidade para a qual está garantida a validade estatística das informações.
% Obter com Orlando artigo da Conferência da Costa Rica 
\end{compactitem}
...
\begin{quadro}[htb]
    \IBGEtab{
        \renewcommand{\arraystretch}{1.5}
        \ABNTEXfontereduzida
        \caption[Layout]{\label{qua:layout-haydee}\emph{Layout} do banco de dados integrador das bases OD-1977, OD-1987, OD-1997 e OD-2007}
	}{%
           ...
           \hline
		    ...
		    \hline
   			...
   			\hline		    	
		        ...
		        12&
		        Composição de ID com ano, zona, subzona, domicílio e família\\
   			\hline		    	
		        \layoutColA{2}{17}&
		        \layoutColB{2}{F_FAM}&
        ...
        \begin{tabular}{|P{\layoutTamColA}|P{\layoutTamColB}|P{\layoutTamColC}|P{\layoutTamColD}|p{\layoutTamColE}|}
           \hline
		    ...
		    \hline\hline
   			...
   			\hline		
		        \layoutColA{3}{85}&  %%%%%%%%%%%% DEPOIS CONFERIR ESTAS CATEGORIAS %%%%%%%%%%%5
